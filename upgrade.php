...
<meta name="author"
	content="CodeRS - MightMedia TVS scripts www.coders.lt" />
<meta name="copyright" content="copyright (c) by CodeRS www.coders.lt" />
<meta name="rating" content="general" />
<meta name="generator" content="notepad" />
<script src="javascript/jquery/jquery-1.3.1.min.js"
	type="text/javascript"/>
<script src="javascript/jquery/tooltip.js" type="text/javascript"><script></script>
<title>MightMedia TVS atnaujinimas</title>
<link rel="stylesheet" type="text/css" media="all"
	href="stiliai/remontas/css/default.css" />
</head>
<body>
<div id="admin_main">
...
<div id="admin_hmenu"
	style="font-weight: bold; font-size: 25px; color: #666; padding: 10px; margin-bottom: 10px;">
<?php echo input(strip_tags($conf['Pavadinimas'])); ?></div>
<?php if (isset($_SESSION['id']) && $_SESSION['id'] == 1) {
	?>
<center><?php if (versija() < $versija)
echo "<div class=\"msg\" style=\"width: 80%;\"><b>Nepakeisti senosios versijos failai!</b><br /> <small>Naudodamiesi FTP naršykle, atnaujinkite senos <b>" . versija() . "</b> versijos failus į naująją <b>$versija</b> versiją.</div>"; ?>
<table border="0" cellpadding="2" cellspacing="5" width="80%"
	id="container">
	<tbody>
		<tr>
			<td width="30%" valign="top" class="left">
			<h1 title="Įdiegimo stadijos. Viską atlikite su įpatingu atidumu.">Įdiegimo
			stadijos</h1>
			<div class="vidus">
			<ul>
			<?php
			...
			<hr />
			Produktas: <a href="http://www.mightmedia.lt/" target="_blank">MightMedia
			TVS</a> <br />
			</div>
			</td>
			...
			<div class="tr"><img
				src="<?php echo (isset($update_url) ? 'images/icons/tick.png' : 'images/icons/cross.png'); ?>" />
			priedai/conf.php faile, prieš <input type="text"
				value='$prisijungimas_prie_mysql = mysql_connect($host, $user, $pass)' />
			įklijuokite šį kodą <input type="text"
				value='$update_url = "http://www.assembla.com/code/mightmedia/subversion/node/blob/naujienos.json?jsoncallback=?";' />
			</div>
			<div class="tr"><img
				src="<?php echo (!function_exists('lentele') ? 'images/icons/tick.png' : 'images/icons/cross.png'); ?>" />
			Failo apačioje ištrinkite kodą <input type="text"
				value='require_once(realpath(dirname(__file__))."/../stiliai/".$conf[&#039;Stilius&#039;]."/sfunkcijos.php");' />
			</div>
			<div class="tr">Atlikę šias užduotis spauskite „Atnaujinti“ ir
			įsitikinlite, kadužduotys atliktos teisingai (žr. į ikonas šalia
			užduoties)</div>
			<center><input type="reset" value="Atnaujinti"
				onclick="JavaScript:location.reload(true);" /> <input type="reset"
				value="Toliau >>" onclick="Go('3');" /></center>
				<?php
			}
			...
			<center><input name="finish" type="submit" value="Pabaigti"
				class="submit" /></center>
			</form>
			<?php
			}
...
<center id="container">
<h1>Tik tinklalapio savininkui</h1>
<div class="vidus"><?php echo admin_login_form(); ?></div>
</center>
			<?php } ?> <span
	style="text-align: right; position: absolute; bottom: 0; right: 0; padding: 5px;">&copy;
<a href="http://mightmedia.lt" style="color: #666;" target="_blank">MightMedia
TVS</a></span></div>
</body>
</html>
			<?php
