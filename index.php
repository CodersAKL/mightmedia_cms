...
// Įterpiam nustatymų failą jei ne - perkialiam į instaliaciją
clearstatcache();
...
// Jei svetainė uždaryta remontui ir jei jungiasi ne administratorius
...
if ( is_file( 'install/index.php' ) && $_SESSION['level'] == 1 && !@unlink( 'install/index.php' ) ) {
	die( '<h1>Demesio / Warning</h1><h3>Neištrintas install/index.php failas.</h3> Tai saugumo spraga. Prašome pašalinkite šį failą iš serverio arba pakeiskite jo pavadinimą. /Please, remove install/index.php file from server.</h3>' );
}
