 ...
 * neveikia funkcija siteUrl(), gražina kelią iki ten, kur esi, tai netinka administravimui ir manageriui, suprantu, kodėl visi tvsai klausia kur instaliuotas TVS'AS, gal reiktų į configą tokį laukelį įkišt?
 ...
 * teisės
 * truputis validumo
 * siteUrl() gal dar patobulint reikėtų
