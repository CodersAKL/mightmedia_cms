...
<head>
    ...
    <title>MightMedia CMS setup / MightMedia TVS įdiegimas</title>
</head>
...
<body class="page">
    <div class="page--logo">
            ...
            <small>MightMedia CMS setup / MightMedia TVS įdiegimas</small>
        </div>
    <div class="container">
       <div class="row">
       <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="body">
                        <?php
                            $steps = [
                                0 => 'Kalbos pasirinkimas',
                                1 => $lang['setup']['liceanse'], 
                                2 => $lang['setup']['file_check'], 
                                3 => $lang['setup']['database'], 
                                4 => $lang['setup']['admin'], 
                                5 => $lang['setup']['admin_dir'], 
                                6 => $lang['setup']['time_zone'], 
                                7 => $lang['setup']['end'] 
                            ];
                        ?>
    ...
    <!-- <script src="<?php echo adresas(); ?>js/pages/examples/sign-in.js"></script> -->
</body>
