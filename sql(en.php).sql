...
('Welcome to the introduction of MightMedia CMS ', 0,'You have successfully installed <a target="_blank" href="http://www.mightmedia.lt"> MightMedia CMS </a>. They are the authors of the <a target =" _blank href = "http://coders.lt"> <strong> CodeRS </strong> </a>. \r\n', 1213129845, 'Admin', 'taip', 'TAIP');
...
('Pavadinimas', 'MightMedia CMS'),
('Apie', 'About'),
('Keywords', 'CMS, mightmedia, coders'),
('Copyright', '<a href="http://www.mightmedia.org" target="_blank">MightMedia CMS</a>'),
('Palaikymas', '1'),
('Maintenance', 'Came back later.'),
('Chat_limit', '5'),
('News_limit', '5'),
('Stilius', 'default'),
('Bandymai', '3'),
...
('Forum', 'frm.php', 3, 'Y'),
('News', 'naujienos.php', 1, 'Y'),
('About', 'apie.php', 5, 'Y'),
('Register', 'reg.php', 13, 'N'),
('Password', 'slaptazodzio_priminimas.php', 12, 'N'),
('Profile', 'edit_user.php', 11, 'N'),
('Search', 'search.php', 6, 'Y'),
('PM', 'pm.php', 0, 'N'),
('Profile', 'view_user.php', 9, 'N'),
('Users', 'nariai.php', 10, 'Y'),
('Gallery', 'galerija.php', 4, 'Y'),
('Articles', 'straipsnis.php', 2, 'Y');
...
('User', 'vartotojas.php', 1, 'L', 'Y'),
('Menu', 'meniu.php', 2, 'L', 'Y'),
('Shoutbox', 'shoutbox.php', 4, 'R', 'Y');
