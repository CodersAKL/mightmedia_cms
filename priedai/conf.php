...
$user = "testas";                                //db vartotojas
$pass = "testas";                                //slaptazodis
$db = "mightmedia";                                    //Duomenu baze
define("LENTELES_PRIESAGA", "tt_");  //Lenteliu pavadinimu priesaga
$slaptas = "2cb887c4097d83c4fc3b8c00be1f86fb";               //Sausainiams ir kitai informacijai

//Admin paneles vartotojas ir slaptazodis
$admin_name="Admin"; //useris
$admin_pass="admin"; //slaptazodis
$admin_email="fds@sdf.ly";                  //e-pastas
