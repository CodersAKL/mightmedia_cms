...
class dsRTEImagePlugin extends dsRTECommandButton
{
    ...
    {
        $this->attributes[] = '"path":"'.DIR.'/uploadhandler.php"';
    ...
    public function getScripts()
    {
        ...
        self::$scripted = true;
        return implode( "\n", array(
            '<script type="text/javascript" src="'.DIR.'lib/plugins/image.js"></script>',
            '<script type="text/javascript" src="'.DIR.'lib/plugins/ajaxfileupload.min.js"></script>',
        ) );
    }
}
