...
case "img":
img=_5;
if(/mediaItem(Flash|ShockWave|WindowsMedia|QuickTime|RealMedia|Flv|Playlist)/.test(_5.className)){
_d.push(null,[Xinha._lc("_Media Properties...","ContextMenu"),function(){
Media.prototype.buttonPress(_7);
},Xinha._lc("Show the media properties dialog","ContextMenu"),_8.btnList["InsertMedia"][1]]);
}else{
...
if(/mediaItem(Flash|ShockWave|WindowsMedia|QuickTime|RealMedia|Flv|Playlist)/.test(_c.className)){
var remove=_c.className;
}else{
var remove=_c.tagName;
}
_9.push(null,[Xinha._lc({string:"Remove the $elem Element...",replace:{elem:"&lt;"+remove+"&gt;"}},"ContextMenu"),function(){
if(confirm(Xinha._lc("Please confirm that you want to remove this element:","ContextMenu")+" "+remove)){
var el=_c;
var p=el.parentNode;
p.removeChild(el);
if(Xinha.is_gecko){
