	...
	if ($url['c'] == 'edit') {
		...
		if (isset($pageId) && pageAssemblerDBexist('pa_data')) {
			...
			if (isset($_GET['insertBlock'])) {
				...
				$config = include $extensionPrefix . '/page_assembler/list_blocks/config.php';
		...
		<div class="card">
			...
			<div class="body clearfix">
				...
				// todo fix path ant files loading
				// $block_list_json = file_get_contents('../../content/extensions/page_assembler/block_list.json');
				$getJson = '{
					"content":{
					   "form_blocks":{
				...
				$block_list = json_decode($getJson, true);
				$categoriesCount  = 0; ?>
