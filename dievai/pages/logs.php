...
if ( !empty( $url['t'] ) ) {
	...
	mysql_query1( "INSERT INTO `" . LENTELES_PRIESAGA . "logai` (`action` ,`time` ,`ip`) VALUES (" . escape( " " . $_SESSION[SLAPTAS]['username'] . ":" . getLangText('admin',  'logs_logsdeleted') . "." ) . ", '" . time() . "', '" . escape( getip() ) . "')" );
