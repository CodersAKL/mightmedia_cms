...
<div id='plotis'>
    <div id='kaire'>
	<div class='skalpas'><a href='".adresas()."' title='".adresas()."'><div class='logo'></div></a>
	</div>
	</div>
    <div id='kunas'>
	<?php if (!empty($strError)):?>
	<div class='klaida'><div class='info_ikona'></div>
    <div class='info_pavadinimas'><?php echo $lang['system']['warning']; ?><blink>!</blink></div>
