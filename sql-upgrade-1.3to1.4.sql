...
INSERT INTO `nustatymai` VALUES(19, 'F_urls', ';') ON DUPLICATE KEY UPDATE val=';';

INSERT INTO `nustatymai` VALUES(20, 'galorder', 'data') ON DUPLICATE KEY UPDATE val='data';

INSERT INTO `nustatymai` VALUES(21, 'galorder_type', 'DESC') ON DUPLICATE KEY UPDATE val='DESC';

INSERT INTO `nustatymai` VALUES(22, 'Editor', 'markitup') ON DUPLICATE KEY UPDATE val='markitup';
