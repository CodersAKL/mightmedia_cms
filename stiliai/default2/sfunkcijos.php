...
function lentele_l($pavadinimas, $tekstas, $label = false) {
    ...
    <div class=\"block\">{$tekstas}</div>";
}

function lentele($pavadinimas, $tekstas, $label = false) {
	echo '
					<h2>'.$pavadinimas.'</h2>
							<div class="content">	'.$tekstas.'</div><br />
				';
}
...
function bbk($forma) {
	$return = "
<button onclick=\"addText('$forma', '[b]', '[/b]'); return false;\" title=\"B\"><img src=\"".ROOT."images/icons/text_bold.png\"></button>
<button onclick=\"addText('$forma', '[i]', '[/i]'); return false;\" title=\"I\"><img src=\"".ROOT."images/icons/text_italic.png\"></button>
<button onclick=\"addText('$forma', '[u]', '[/u]'); return false;\" title=\"U\"><img src=\"".ROOT."images/icons/text_underline.png\"></button>
<button onclick=\"addText('$forma', '[url]', '[/url]'); return false;\" title=\"URL\"><img src=\"".ROOT."images/icons/link.png\"></button>
<button onclick=\"addText('$forma', '[big]', '[/big]'); return false;\" title=\"BIG\"><img src=\"".ROOT."images/icons/text_heading_1.png\"></button>
<button onclick=\"addText('$forma', '[sm]', '[/sm]'); return false;\" title=\"SM\"><img src=\"".ROOT."images/icons/text_heading_6.png\"></button>
<button onclick=\"addText('$forma', '[img]', '[/img]'); return false;\" title=\"IMG\"><img src=\"".ROOT."images/icons/picture.png\"></button>
<button onclick=\"addText('$forma', '[quote]', '[/quote]'); return false;\" title=\"QUOTE\"><img src=\"".ROOT."images/icons/comment.png\"></button> 
";
	if (LEVEL == 1) {
		$return .= "
...
function smile($data, $bb = false) {
	...
	foreach ($smilies as $smile => $image) {
		...
		$data = str_replace($smile, "<img src='".ROOT."images/smiles/$image' alt='" . $smile . "' class='middle' onclick=\"addText('" . $bb . "','" . $smile . "',' ');\" style='cursor: pointer;' />", $data);
	}
	return $data;
}
