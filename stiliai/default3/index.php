...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
	<head>
		<?php header_info(); ?>
		<link rel="stylesheet" type="text/css" href="stiliai/<?php echo input($conf['Stilius']); ?>/superfish.css" media="screen" />
		<script type="text/javascript" src="stiliai/<?php echo input($conf['Stilius']); ?>/superfish.js"></script>
	...
	<body>
		<div id="main">
			...
			<div class="login">
				<?php
					include "stiliai/" . $conf['Stilius'] . "/vartotojas.php";
					echo $text;
					include_once 'paneles/vartotojas.php';
					unset($title, $text);
				?>
			</div>
			<div id="content">
			...
			<div class="copyright"><?php copyright($conf['Copyright']); ?></div>
		</div>
	</body>
</html>