...
if ( sizeof( $q ) > 0 ) {
	...
	foreach ( $q as $row ) {
		if ( $row['pid'] == 'content/pages/naujienos' && puslapis( 'naujienos.php' ) ) {
			//$extra = "Naujienos";
			$link = "k," . $row['kid'];
		} elseif ( $row['pid'] == 'content/pages/siustis' && puslapis( 'siustis.php' ) ) {
		...
		elseif ( $row['pid'] == 'content/pages/straipsnis' && puslapis( 'straipsnis.php' ) ) {

			//$extra = "Straipsniai";
			$link = "m," . $row['kid'];
		} //?id,22;p,14;t,14#325
		elseif ( $row['pid'] == 'content/pages/galerija' && puslapis( 'galerija.php' ) ) {
			//$extra = "Galerija";
			$link = "m," . $row['kid'];
		} //?id,46;a,12;v,8#7
		elseif ( $row['pid'] == 'content/pages/view_user' && puslapis( 'view_user.php' ) ) {
			//$extra = "Vartotojai";
			$link = "m," . $row['kid'];
		} elseif ( $row['pid'] == 'content/pages/todo' && puslapis( 'todo.php' ) ) {
			//$extra = "Vartotojai";
			$link = "v," . $row['kid'];
		} elseif ( $row['pid'] == 'content/pages/codebin' && puslapis( 'codebin.php' ) ) {
			//$extra = "Vartotojai";
			$link = "c," . $row['kid'];
		}
		elseif ( $row['pid'] == 'content/pages/blsavimo_archyvas' && puslapis( 'blsavimo_archyvas.php' ) ) {
			//$extra = "Vartotojai";
			$link = "m," . $row['kid'];
		}
